var Custombox = (function ( w, d, h ) {
    ...
    _private = {
        ...
        check: function () {
            ...
            // Trigger open.
			$(d).trigger("custombox.open", true, true);
			/*
			if(d.createEvent){
				...
				d.dispatchEvent(topen);
				  ...
				  var evObj = d.createEventObject();
				  console.log(d.fireEvent);
				  d.fireEvent('onclick', evObj);
			}*/			
        ...
        open: function () {
            if ( _cache.settings[_cache.item].overlay ) {
                ...
                if ( _config.overlay.together.indexOf( _cache.settings[_cache.item].overlayEffect ) > -1 ) {
                    $(_cache.wrapper[_cache.item]).addClass('custombox-modal-open');
                } else {
                    var open = function () {
